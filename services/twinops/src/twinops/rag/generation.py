...
def _build_gateway_messages(
    *,
    ...
    system = (
        ...
        "verbatim from its chunk. Select one or two short, complete passages with unique "
        "chunkId values that directly answer the question. Prefer one passage when "
        "it is sufficient. Preserve every applicable safety condition and qualification; "
