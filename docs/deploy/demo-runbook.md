...
- O bundle medido tem 135,872 MiB contra o limite padrão de 225 MiB; Large
  Functions não é necessário nem foi habilitado.
- O trace contém o entrypoint, a migration `002_real_twin_v2.sql`, os cinco
  arquivos ML fixados e as dependências NumPy/Pandas/joblib. Não contém
  `.env.local`, testes, skills locais, SciPy ou scikit-learn.
...
dentro da janela confirmada pelo backend:
